...
<div class="container target">
    <div class="row">
        ...
        <button type="button" class="btn btn-info">S'abonner</button>
<br>
        </div>
  ...
  <br>
    <div class="row">
        ...
        <div class="panel-body"><a href="modifier.php" class="">Modifier le profil</a></br>   
        <div class="panel-body"><a href="deleting.php" class="">Supprimer ce profil</a></br>
</div></div>
