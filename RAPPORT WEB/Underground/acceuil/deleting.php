...
if(isset($_POST['confirmation'])) {
  $sql = 'DELETE FROM users WHERE id = $f ';
  $q -> exec($sql);
  header("Location:../acceuil/index1.php");
}
...
<main role="main" class="container">
  ...
  <div class="jumbotron">
    ...
    <h1>Etes vous de vouloir nous quitter ?</h1>
    
    <input type="submit" class="btn btn_primary btn-lg" value="Oui" name="confirmation"/>
    
    <a href="profil.php" class="btn btn-primary btn-lg">Non</a>
    </p>
  </div>
