...
<header>
    <ul class="topnav">
        ...
        <li class="left-side"><a class="nav-link" href="/Forms/searchKara.php">Advanced Search</a></li>
        <li class="left-side"><a class="nav-link" href="/playlists/playlists.php">Playlists</a></li>
