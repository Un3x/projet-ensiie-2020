<?php include('includes/header.php') ;?>
 ...
 <?php if (isset($_SESSION['firstname'])) { ?>
        <div class="w3-col w3-animate-opacity"style="width:30% ">
            <button class="w3-button w3-block w3-black" onclick="location.href='speaking.php'">Poster un commentaire</button>
        </div>
...
while($reponse2){
  echo $reponse2['nom']; echo " "; echo $reponse2['prénom']; echo " a répondu: "; echo $reponse2['réponse']; ?></p>
  
  <?php $reponse2=$reponse->fetch(PDO::FETCH_ASSOC);?><?php 
  }
  if (isset($_SESSION['firstname'])) { ?>
  <p><button><?php echo '<a href="answer.php">Répondre</a> '; ?></button></p> <br> <?php }?>
</div>
</div>
</div>
