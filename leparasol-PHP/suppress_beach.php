...
include('includes/dbh.inc.php');
 ...
 $sql='SELECT * FROM public."Beach"';
    ...
    ?> <table> <thead> <tr> <th> Nom </th> <th> Description </th> <th> Note </th> </tr> </thead> 
     <colgroup>
...
padding:5px; /* Petite marge intérieure aux cellules pour éviter que le texte touche les bordures */
    ...
    while ($row=$result->fetch(PDO::FETCH_ASSOC)) {
     ...
     <div id="find-user">
     <div class="center">
     <h1 class="finding"> Supprimer une plage</h1>
     <form class="finding_user" action="suppressing_beach.php" method="post">
          <input type="text" name="beach" placeholder="Plage à supprimer" />
