...
if(isset( $_POST['post'])){
    ...
    if (empty($plage)|| empty($comment)||empty($note))  {
        ...
        <p>Cliquez <a href="speaking.php">ici</a> pour revenir</p>';
        ?><footer class="footer">
...
<?php
    ...
    if (!($row=$result->fetch(PDO::FETCH_ASSOC))) {
        ...
        <p>Cliquez <a href="commentok.php">ici</a> pour revenir</p>';
        exit();
    }
    ...
    $note_nouvelle=($ancienne_note+$note)/($nombre+1);
        ...
        echo '<p> Votre commentaire a bien été ajouté! </p> <p> Retourner a l espace échange en cliquant <a href="speak.php">ici</a></p> ';
    }
  }
  ?><footer class="footer">
        <div class="footer__addr">
