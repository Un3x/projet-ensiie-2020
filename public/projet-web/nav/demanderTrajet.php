...
<main>
	<div class="container wrapper">
		...
		<div class="wrapperC col-lg">
			<form action="/projet-web/includes/demanderTrajet.inc.php" method="POST">
				...
				<!-- Adresse départ -->
				<label for="adresse1"><b>Départ:</b></label><br>
				...
				<br>
				<button type="submit" name="demanderTrajet">Demander le trajet</button>
